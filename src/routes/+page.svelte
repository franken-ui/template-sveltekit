...
<div class="uk-container uk-container-xl mt-40 grid gap-y-8 md:grid-cols-2">
	<div class="space-y-4">
		...
		<p class="text-lg font-light">A sleek UI, with DX that's old-school high.</p>
		<div class="flex gap-x-1">
			<a class="uk-btn uk-btn-primary" href="https://next.franken-ui.dev/docs/2.0/introduction">
				Learn
			</a>
			<a
			...
			<div class="uk-inline">
				<button class="uk-btn uk-btn-default uk-btn-icon" aria-label="Customize">
				...
				<div class="uk-card uk-card-body uk-drop w-96" data-uk-drop="mode: click; offset: 8">
					...
					<p class="mb-4 mt-1 text-muted-foreground">Customize your Franken UI experience.</p>
					<uk-theme-switcher id="theme-switcher">
						<select hidden>
							<optgroup data-key="theme" label="Theme">
								...
								<option data-hex="#f97316" value="uk-theme-orange" selected>Orange</option>
	...
	<div class="">
		...
		<ul class="uk-list uk-list-hyphen mt-4">
			<li>
				<a class="uk-link" href="https://bsky.app/profile/sveltecult.bsky.social" target="_blank">
					https://bsky.app/profile/sveltecult.bsky.social
				</a>
			</li>
			<li>
				<a class="uk-link" href="https://github.com/sveltecult" target="_blank">
					https://github.com/sveltecult
				</a>
			</li>
			<li>
				<a class="uk-link" href="https://github.com/franken-ui" target="_blank">
